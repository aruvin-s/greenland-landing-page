  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center justify-center text-center px-4 sm:px-10 md:px-20 lg:px-[104px] h-full">
        <h1 className="font-mirage font-bold text-white text-4xl sm:text-5xl md:text-6xl lg:text-[64px] leading-tight pb-3">
          Harmoni di Antara <br /> Malang dan Batu
        </h1>

        <p className="font-jakarta text-white text-base sm:text-lg md:text-xl leading-relaxed max-w-2xl pb-6">
